...
class Splitter:
    def __init__(self, input_path, balance: bool, ratio: float = 0.8):
        ...
        self.valid_test_len = round(self.rejected_list_len * 0.2)
        self.train_len = round(self.rejected_list_len * ratio)
        if not balance:
            self.train_len = round(self.accepted_list_len * ratio)
...
if __name__ == '__main__':
    ...
    splitter = Splitter(input_dir, False, 0.1)
